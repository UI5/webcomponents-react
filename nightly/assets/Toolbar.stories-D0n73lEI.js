import{q as p,j as e,Y as o,aJ as U,t as E,ak as _,fD as j,T as c,V as t,I as D,cH as h,N as R}from"./iframe-BVmbmlmH.js";import{f as b}from"./favorite-BFOyziy-.js";import{s as A}from"./settings-DWvv_yar.js";import{D as L}from"./index-BbRcs0TO.js";import{I as k}from"./index-DFtwu3lL.js";import{M as O}from"./index-DArcVnMs.js";import{S as M}from"./index-C-VIxdSF.js";import{S as F}from"./index-Btd12Hqd.js";import{S as q}from"./index-BplB5G32.js";import{T as I}from"./index-OS6XWPB1.js";import{u as C,a as H,b as W,c as i,T as S}from"./index-C5BT_wNS.js";const d=p.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});d.displayName="OverflowToolbarButton";try{d.displayName="OverflowToolbarButton",d.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
