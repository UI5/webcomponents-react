import"./IllustratedMessage-eRr0GKWI.js";import{w as n}from"./iframe-BCh37-GP.js";const e=n("ui5-illustrated-message",["accessibleNameRef","design","name","subtitleText","titleText"],["decorative"],["subtitle","title"],[]);e.displayName="IllustratedMessage";try{e.displayName="IllustratedMessage",e.__docgenInfo={description:`An IllustratedMessage is a recommended combination of a solution-oriented message, an engaging
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-fiori**.`,name:"design",required:!1,type:{name:"enum",value:[{value:'"Auto"'},{value:'"Base"'},{value:'"Dot"'},{value:'"Spot"'},{value:'"Dialog"'},{value:'"Scene"'},{value:'"ExtraSmall"'},{value:'"Small"'},{value:'"Medium"'},{value:'"Large"'},{value:'"Auto"'},{value:'"Base"'},{value:'"Dot"'},{value:'"Spot"'},{value:'"Dialog"'},{value:'"Scene"'},{value:'"ExtraSmall"'},{value:'"Small"'},{value:'"Medium"'},{value:'"Large"'}]}},name:{defaultValue:{value:'"BeforeSearch"'},description:`Defines the illustration name that will be displayed in the component.
