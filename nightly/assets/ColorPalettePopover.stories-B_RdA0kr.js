import{n as w,c as p,cV as y,F as g,b9 as _,f as b,d as D,b as R,s as c,d5 as T,S as I,aT as x,e as O,aw as S,aA as P,aB as j,d6 as E,d7 as B,w as k,_ as N,q as C,j as o,Y as q}from"./iframe-rmPOfAEk.js";import{a as A,C as l}from"./index-Etkv_lwE.js";import{R as M}from"./ResponsivePopoverCommon.css-GT00HLHH.js";function V(){return w(_,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:this.placement,opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(y,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(A,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>p("slot",{name:t._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(g,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}b("@ui5/webcomponents-theming","sap_horizon",async()=>D);b("@ui5/webcomponents","sap_horizon",async()=>R,"host");const U=`.ui5-cp-header{width:100%;height:var(--_ui5_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var i=function(t,e,a,s){var u=arguments.length,n=u<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,a):s,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,a,s);else for(var v=t.length-1;v>=0;v--)(f=t[v])&&(n=(u<3?f(n):u>3?f(e,a,n):f(e,a))||n);return u>3&&n&&Object.defineProperty(e,a,n),n},m;let r=m=class extends j{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1,this.placement="Bottom"}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){const e=this._colorPalette;e._currentlySelected?e._currentlySelected?.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e._defaultColorButton?.focus(),e.allColorsInPalette.forEach(a=>{const s=a.offsetHeight+4;a.style.setProperty("--_ui5_color_palette_item_height",`${s}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(E)}get _cancelButtonLabel(){return m.i18nBundle.getText(B)}get _open(){return this.open||void 0}};i([c({type:Boolean})],r.prototype,"showRecentColors",void 0);i([c({type:Boolean})],r.prototype,"showMoreColors",void 0);i([c({type:Boolean})],r.prototype,"showDefaultColor",void 0);i([c()],r.prototype,"defaultColor",void 0);i([c({type:Boolean})],r.prototype,"open",void 0);i([c({converter:T})],r.prototype,"opener",void 0);i([c()],r.prototype,"placement",void 0);i([I({default:!0,type:HTMLElement,individualSlots:!0})],r.prototype,"colors",void 0);i([x("@ui5/webcomponents")],r,"i18nBundle",void 0);r=m=i([O({tag:"ui5-color-palette-popover",renderer:S,styles:[M,U],template:V}),P("item-click",{bubbles:!0}),P("close",{bubbles:!0})],r);r.define();const h=k("ui5-color-palette-popover",["defaultColor","opener","placement"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);h.displayName="ColorPalettePopover";try{h.displayName="ColorPalettePopover",h.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
