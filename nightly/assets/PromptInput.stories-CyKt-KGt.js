import{l as m,c as r,co as g,a1 as y,p as v,d as S,s as o,A as w,ar as _,m as N,b7 as f,ai as A,b5 as x,b9 as I,w as P,R as C}from"./iframe-DUkvwiCH.js";import{d as T,P as D,a as E}from"./parameters-bundle.css-Chce_F9i.js";import{I as q}from"./Input-DQ5p6nKI.js";import{p as V}from"./paper-plane-CB6ae7Yb.js";function M(){return m("div",{class:"ai-prompt-input-wrapper",children:[this.label&&r(g,{for:"input",children:this.label}),m("div",{class:"ai-prompt-input-form-wrapper",children:[m("div",{class:"ai-prompt-inner-input-wrapper",children:[m(q,{id:"input",value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,children:[r("slot",{}),this.valueStateMessage.length>0&&r("slot",{name:"valueStateMessage",slot:"valueStateMessage"})]}),this.showExceededText&&r(g,{class:"ai-prompt-input-counter",children:this._exceededText})]}),r(y,{icon:V,disabled:this._submitButtonDisabled,class:"ai-prompt-input-button",design:"Emphasized",onClick:this._onButtonClick})]})]})}v("@ui5/webcomponents-theming","sap_horizon",async()=>S);v("@ui5/webcomponents-ai","sap_horizon",async()=>T);const R=`.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
