import{w as N,l as W,c as D,p as S,d as F,b as P,s as y,ar as V,m as q,ai as M,b5 as E,gg as U,gh as B,gi as A,gj as R,A as O,b7 as I,dm as j,f0 as H,ff as z,be as G,bf as $,gk as J,j as l}from"./iframe-DUkvwiCH.js";import{s as K}from"./Gregorian-NGdj3WsM.js";import"./Persian-BeWfvbm0.js";import{e as Y}from"./Calendar-CDyXZjYT.js";const v=N("ui5-calendar",["calendarWeekNumbering","displayFormat","formatPattern","maxDate","minDate","primaryCalendarType","secondaryCalendarType","selectionMode","valueFormat"],["hideWeekNumbers"],["calendarLegend","specialDates"],["selection-change"]);v.displayName="Calendar";try{v.displayName="Calendar",v.__docgenInfo={description:`The \`Calendar\` component allows users to select one or more dates.
...
**Note:** Available since [v2.14.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v2.14.0) of **@ui5/webcomponents**.`,name:"valueFormat",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const ae={title:"Inputs / Calendar",component:v,argTypes:{children:{control:{disable:!0}},specialDates:{control:{disable:!0}}},args:{primaryCalendarType:K.Gregorian,selectionMode:Y.Single},tags:["package:@ui5/webcomponents"]},T={},L=new Date,x=new Date(L.getFullYear(),L.getMonth(),1),u=`${x.getFullYear()}-${(x.getMonth()+1).toString().padStart(2,"0")}-`,ne=`${u}${x.getDate()}`,C={args:{specialDates:l.jsx(d,{type:o.Type01,value:ne})}},w={name:"CalendarLegend",args:{calendarLegend:l.jsxs(b,{children:[l.jsx(c,{text:"Vacation",type:o.Type05}),l.jsx(c,{text:"School Vacation",type:o.Type07}),l.jsx(c,{text:"Wedding",type:o.Type13})]}),specialDates:l.jsxs(l.Fragment,{children:[l.jsx(d,{type:o.Type05,value:`${u}01`}),l.jsx(d,{type:o.Type05,value:`${u}02`}),l.jsx(d,{type:o.Type05,value:`${u}03`}),l.jsx(d,{type:o.Type07,value:`${u}11`}),l.jsx(d,{type:o.Type07,value:`${u}12`}),l.jsx(d,{type:o.Type07,value:`${u}13`}),l.jsx(d,{type:o.Type13,value:`${u}26`})]})}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:"{}",...T.parameters?.docs?.source}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
