const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Calculator-CXZSsww7.js","./chunk-zsgVPwQN.js","./Illustrations-BIBsPpgU.js","./Theme-_KKQCWbc.js","./Calculator-DPTzYN1i.js"])))=>i.map(i=>d[i]);
...
`})),m;e((()=>{i(),s(),l(),d(),p(),t(),r(`tnt/V5/Calculator`,async function(){return(await n(async()=>{let{default:e}=await import(`./Calculator-CXZSsww7.js`);return{default:e}},__vite__mapDeps([0,1,2,3]),import.meta.url)).default}),r(`tnt/V5/HC/Calculator`,async function(){return(await n(async()=>{let{default:e}=await import(`./Calculator-DPTzYN1i.js`);return{default:e}},__vite__mapDeps([4,1,2,3]),import.meta.url)).default}),a(`Calculator`,{dialogSvg:o,sceneSvg:c,spotSvg:u,dotSvg:f,set:`tnt`,collection:`V4`}),m=`tnt/Calculator`}))();export{m as default};