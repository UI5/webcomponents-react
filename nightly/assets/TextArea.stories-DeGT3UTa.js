import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{$t as r,An as i,Bp as a,Dd as o,Fp as s,Im as c,Ip as l,Jm as u,Lp as d,Lt as f,Mh as p,Mn as m,Mp as ee,Nh as h,Nn as g,Np as te,Od as ne,Ou as re,Pn as ie,Pp as ae,Qi as oe,Th as _,Tu as se,Vp as v,Wm as ce,Xi as le,Zn as ue,_m as y,ap as de,cm as fe,dm as b,du as pe,en as me,fm as x,gm as S,hm as C,i as he,id as ge,jm as _e,jn as ve,kn as ye,ln as be,lp as xe,mg as Se,mm as w,np as Ce,op as we,ou as T,pm as E,qm as Te,r as Ee,s as De,su as D,tp as Oe,u as ke,um as O,un as Ae,up as je,uu as Me,wh as k,wu as Ne}from"./iframe-BJhVd3ux.js";import{_ as Pe,d as Fe,f as Ie,g as Le,h as Re,l as ze,m as Be,n as A,p as Ve,t as j,u as He,v as Ue,y as M}from"./parameters-bundle.css-Bp5yL5WR.js";import{t as We}from"./navigation-left-arrow-C280kxuo.js";var Ge,Ke=e((()=>{h(),a(),j(),p(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>v),p(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>A,`host`),Ge=`.ui5-ai-textarea-root{position:relative;display:flex;flex-direction:column;width:100%;height:100%}.ui5-ai-textarea-root .ui5-textarea-wrapper{display:flex;flex-direction:column;flex:1;position:relative}.ui5-ai-textarea-root [part=footer]{position:relative;width:100%;margin-top:auto;flex-shrink:0}.ui5-ai-writing-assistant-footer-bar{background:var(--_ui5_texteditor_toolbar_background, var(--sapPageFooter_Background));width:100%;box-sizing:border-box;box-shadow:none;border-bottom:none;border-top:none}.ui5-ai-writing-assistant-footer-bar--with-border{border-top:1px solid var(--sapPageFooter_BorderColor)}.ui5-ai-writing-assistant-action-label{margin-left:.5rem;color:var(--sapContent_LabelColor);font-size:var(--sapFontSmallSize)}#ai-menu-wrapper{position:relative;z-index:1000}
