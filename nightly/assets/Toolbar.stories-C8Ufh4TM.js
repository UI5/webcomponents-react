import{n as d,j as e,U as o,aI as P,p as R,ah as _,fC as j,T as c,Q as t,I as D,cG as h,M as E}from"./iframe-C-8CikNF.js";import{f as b}from"./favorite-D8kQL-zz.js";import{s as A}from"./settings-Cxaoyz_-.js";import{D as L}from"./index-BPqvgGLl.js";import{I as k}from"./index-BGWYkQPr.js";import{M as O}from"./index-xpd0kxl9.js";import{S as M}from"./index-C4LEWr2J.js";import{S as F}from"./index-ZotG_VQu.js";import{S as q}from"./index-2SjK2Mh1.js";import{T as I}from"./index-CWsH9Itz.js";import{u as C,a as W,b as H,c as i,T as S}from"./index-Cd7ldoZy.js";const u=d.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});u.displayName="OverflowToolbarButton";try{u.displayName="OverflowToolbarButton",u.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Available since [v2.13.0](https://github.com/UI5/webcomponents/releases/tag/v2.13.0) of **@ui5/webcomponents**.`,name:"loadingDelay",required:!1,type:{name:"number"}},design:{defaultValue:{value:'"Default"'},description:"Defines the component design.",name:"design",required:!1,type:{name:'"Default" | "Positive" | "Negative" | "Transparent" | "Emphasized" | ButtonDesign | "Attention"'}},disabled:{defaultValue:{value:"false"},description:`Defines whether the component is disabled.
