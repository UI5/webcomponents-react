import{n as d,j as e,U as o,aI as P,p as R,ah as _,fC as j,T as c,Q as t,I as D,cG as h,M as E}from"./iframe-EDZrvS0_.js";import{f as b}from"./favorite-Cqw7gRrl.js";import{s as A}from"./settings-CAIkTOU2.js";import{D as L}from"./index-BHJ7j_nl.js";import{I as k}from"./index-CUNI2Fe2.js";import{M as O}from"./index-ZCLzsSfY.js";import{S as M}from"./index-CA1Jh7mM.js";import{S as F}from"./index-X7FPPGaX.js";import{S as q}from"./index-BO_w0Yy3.js";import{T as I}from"./index-C6dZwhpH.js";import{u as C,a as W,b as H,c as i,T as S}from"./index-C-JIAYI2.js";const u=d.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});u.displayName="OverflowToolbarButton";try{u.displayName="OverflowToolbarButton",u.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Available since [v1.23](https://github.com/UI5/webcomponents/releases/tag/v1.23) of **@ui5/webcomponents**.`,name:"accessibleRole",required:!1,type:{name:'"Button" | ButtonAccessibleRole | "Link"'}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
