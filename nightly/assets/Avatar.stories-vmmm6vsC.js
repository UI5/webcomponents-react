...
\`import "@ui5/webcomponents-icons/dist/{icon_name}.js"\``,name:`icon`,parent:{fileName:`webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`},required:!1,tags:{default:`undefined`},type:{name:`string`}},state:{defaultValue:{value:`"None"`},declarations:[{fileName:`webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`}],description:"Defines the state of the badge, which determines its styling.\n\nAvailable options:\n- `None` (default) - Standard appearance\n- `Positive` - Green, used for success/approved states\n- `Critical` - Orange, used for warning states\n- `Negative` - Red, used for error/rejected states\n- `Information` - Blue, used for informational states",name:`state`,parent:{fileName:`webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`"None" | "Information" | "Positive" | "Negative" | "Critical" | ValueState`,value:[{value:`"None"`},{value:`"Information"`},{value:`"Positive"`},{value:`"Negative"`},{value:`"Critical"`},{value:`"None"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Critical"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Negative"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Information"`,description:``,fullComment:`@public`,tags:{public:``}}]}},tooltip:{defaultValue:{value:`undefined`},declarations:[{fileName:`webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`}],description:`Defines the tooltip text of the badge icon.
