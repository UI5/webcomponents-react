import{w as n}from"./iframe-_UyBg_Hl.js";const e=n("ui5-li-custom",["accessibilityAttributes","accessibleName","highlight","tooltip","type"],["movable","navigated","selected"],["deleteButton"],["detail-click"]);e.displayName="ListItemCustom";try{e.displayName="ListItemCustom",e.__docgenInfo={description:`A component to be used as custom list item within the \`List\`
...
**Note:** Available since [v1.9.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.9.0) of **@ui5/webcomponents**.`,name:"deleteButton",required:!1,type:{name:"UI5WCSlotsNode"}},onDetailClick:{defaultValue:null,description:`Fired when the user clicks on the detail button when type is \`Detail\`.
