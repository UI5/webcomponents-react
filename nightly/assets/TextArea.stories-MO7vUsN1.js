import{p as x,d as L,c as r,s as c,m as D,ai as R,l as v,ag as j,b7 as y,a1 as re,cD as le,gN as O,aq as ue,b4 as ce,bC as de,B as pe,w as he,cC as me,r as C,gO as fe,j as M,X as ge}from"./iframe-CISvTVNI.js";import{T as be,t as ve,a as ye}from"./TextArea-BNVJ-0od.js";import{d as U,V as $,e as K,f as we,g as xe,W as _e,h as X,i as Te,j as Se,k as Ne,l as Ve}from"./parameters-bundle.css-UR8Qxv08.js";import{v as Ae}from"./ValueStateMessage.css-MWCPl9eb.js";import{p as Ce}from"./InvisibleMessage-D74Q5wYE.js";import{T as J,b as V,c as Q}from"./ToolbarButton-D9NdWzL2.js";import"./navigation-left-arrow-DyBCJsG4.js";import"./navigation-right-arrow-BJIZXTFA.js";import{T as Y}from"./ToolbarSpacer-C4wMz1Mq.js";import"./ai-DMMxCG7X.js";import"./stop-7bjrE9Bu.js";import{M as Ie}from"./index-DAneW4f3.js";x("@ui5/webcomponents-theming","sap_horizon",async()=>L);x("@ui5/webcomponents-ai","sap_horizon",async()=>U);const De=`.ui5-ai-textarea-root{position:relative;display:flex;flex-direction:column;width:100%;height:100%}.ui5-ai-textarea-root .ui5-textarea-wrapper{display:flex;flex-direction:column;flex:1;position:relative}.ui5-ai-textarea-root [part=footer]{position:relative;width:100%;margin-top:auto;flex-shrink:0}.ui5-ai-writing-assistant-footer-bar{background:var(--_ui5-v2-17-0-rc-5_texteditor_toolbar_background, var(--sapPageFooter_Background));width:100%;box-sizing:border-box;box-shadow:none;border-bottom:none;border-top:none}.ui5-ai-writing-assistant-footer-bar--with-border{border-top:1px solid var(--sapPageFooter_BorderColor)}.ui5-ai-writing-assistant-action-label{margin-left:.5rem;color:var(--sapContent_LabelColor);font-size:var(--sapFontSmallSize)}#ai-menu-wrapper{position:relative;z-index:1000}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const Le={title:"TextArea",component:g,argTypes:{menu:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},tags:["package:@ui5/webcomponents-ai","experimental"]},S={},Oe="Innovation managers operate with both creativity and business acumen, driving initiatives that cultivate an innovation-friendly culture, streamline the execution of new ideas, and ultimately unlock value for the organization and its customers.",N={name:"with Stream",args:{placeholder:"Write your content here...",rows:8},render(a){const{value:e,isTyping:n,isProcessing:o,setValue:i,startStream:t,stopStream:s}=me(),[l,W]=C.useState([]),[E,k]=C.useState(-1),[te,B]=C.useState(""),G=C.useRef(""),F=o||n,ne=p=>{const{action:b}=p.detail.item.dataset;o||!b||(G.current=b,B("Generating text..."),t({text:Oe,onComplete:se=>{W(P=>[...P,{action:b,endAction:"completed",timestamp:new Date().toISOString(),value:se,promptDescription:"Generated text"}]),k(P=>P+1),i(""),B("")}}))},oe=()=>{s(),z()},z=()=>{W(p=>[...p,{action:G.current,endAction:"stopped",timestamp:new Date().toISOString(),value:e,promptDescription:"Generated text (stopped)"}]),k(p=>p+1),i(""),B("")},ae=p=>{k(b=>p.detail.backwards?b-1:b+1),i("")},ie=p=>{i(p.target.value)};return fe(F,s,z),M.jsx(g,{...a,value:e||l[E]?.value||"",currentVersion:E+1,totalVersions:l.length,loading:F,promptDescription:te||l[E]?.promptDescription||"",onStopGeneration:oe,onVersionChange:ae,onInput:ie,menu:M.jsx(ge,{onItemClick:ne,children:M.jsx(Ie,{text:"Generate text","data-action":"generate"})})})}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:"{}",...S.parameters?.docs?.source}}};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  name: 'with Stream',
  args: {
