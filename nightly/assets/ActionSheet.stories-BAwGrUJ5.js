...
**Note:** Available since [v1.10.0](https://github.com/UI5/webcomponents/releases/tag/v1.10.0) of **@ui5/webcomponents**.`,name:"accessibleRole",required:!1,type:{name:'"None" | PopupAccessibleRole | "Dialog" | "AlertDialog"'}},footer:{defaultValue:null,description:`Defines the footer HTML Element.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"footer",required:!1,type:{name:"UI5WCSlotsNode"}},onOpen:{defaultValue:null,description:`Fired after the component is opened.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onOpen",required:!1,type:{name:"(event: Ui5CustomEvent<ResponsivePopoverDomRef, never>) => void"}},accessibleDescriptionRef:{defaultValue:{value:"undefined"},description:`Receives id(or many ids) of the elements that describe the component.
