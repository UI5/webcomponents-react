import{c as _,gy as q,p as u,d as S,b as w,m as I,av as O,aA as z,gC as g,w as D,aj as v,j as e}from"./iframe-vPuL6nrR.js";import{T as y,a as N}from"./Tab-e6pfAo5C.js";import{a as R}from"./add-BekBRTJ7.js";import{e as F}from"./employee-B2A0OWN8.js";import{m as C}from"./menu-B0TYstcq.js";import{s as $}from"./settings-pLzgs32J.js";import{a as h,T as t}from"./index-DNw5IvYv.js";function L(){return _("div",{id:this._id,role:"separator",class:"ui5-tc__separator",ref:this.captureRef.bind(this)})}function P(){return _(q,{id:this._id,class:"ui5-tc__separator",disabled:!0,style:this._forcedStyleInOverflow,ref:this.captureRef.bind(this)})}u("@ui5/webcomponents-theming","sap_horizon",async()=>S);u("@ui5/webcomponents","sap_horizon",async()=>w);const W=`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
