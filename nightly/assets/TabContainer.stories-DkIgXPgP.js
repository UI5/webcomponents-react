import{c as _,gF as q,p as u,d as S,b as w,m as I,av as O,aA as z,gC as g,w as D,aj as v,j as e}from"./iframe-f3iLPpTx.js";import{T as y,a as N}from"./Tab-Pgvy96t1.js";import{a as R}from"./add-Bhn75ghe.js";import{e as F}from"./employee-DNlCk1Ot.js";import{m as C}from"./menu-DOH14x8w.js";import{s as $}from"./settings-OcBxnIhX.js";import{a as h,T as t}from"./index-CyPHW2AO.js";function L(){return _("div",{id:this._id,role:"separator",class:"ui5-tc__separator",ref:this.captureRef.bind(this)})}function P(){return _(q,{id:this._id,class:"ui5-tc__separator",disabled:!0,style:this._forcedStyleInOverflow,ref:this.captureRef.bind(this)})}u("@ui5/webcomponents-theming","sap_horizon",async()=>S);u("@ui5/webcomponents","sap_horizon",async()=>w);const W=`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
