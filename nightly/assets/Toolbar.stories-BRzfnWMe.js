import{q as d,j as e,Y as o,aJ as P,t as R,ak as _,fD as j,T as c,V as t,I as D,cH as h,N as E}from"./iframe-Cg-RuwYg.js";import{f as b}from"./favorite-Cki4xYOh.js";import{s as A}from"./settings-DJxx_A34.js";import{D as L}from"./index-Cy6QMhKL.js";import{I as k}from"./index-fpUgSqmh.js";import{M as O}from"./index-C_u7_IwQ.js";import{S as M}from"./index-Cuyb1IhG.js";import{S as F}from"./index-Cgnrxc8s.js";import{S as q}from"./index-wdWM-9oK.js";import{T as I}from"./index-xU6WKMgQ.js";import{u as C,a as H,b as W,c as i,T as S}from"./index-CDmdTmyh.js";const u=d.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});u.displayName="OverflowToolbarButton";try{u.displayName="OverflowToolbarButton",u.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Available since [v1.23](https://github.com/UI5/webcomponents/releases/tag/v1.23) of **@ui5/webcomponents**.`,name:"accessibleRole",required:!1,type:{name:'ButtonAccessibleRole | "Button" | "Link"'}},disabled:{defaultValue:{value:"false"},description:`Defines whether the component is disabled.
