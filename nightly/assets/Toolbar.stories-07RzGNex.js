import{r as p,j as e,X as o,aI as U,p as E,aj as j,fG as _,T as c,U as t,I as D,cQ as h,M as R}from"./iframe-DAxVciiO.js";import{f as b}from"./favorite-9vdpiYav.js";import{s as A}from"./settings-BGVa_S9e.js";import{D as L}from"./index-DIcvZ6EF.js";import{I as k}from"./index-_vvkfygM.js";import{M as O}from"./index-UAhEuNZs.js";import{S as M}from"./index-kd3IkrmG.js";import{S as F}from"./index-DpKErTnU.js";import{S as q}from"./index-DocLDr0y.js";import{T as I}from"./index-DK-JaRrB.js";import{u as C,a as W,b as H,c as i,T as S}from"./index-Cycxych_.js";const d=p.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});d.displayName="OverflowToolbarButton";try{d.displayName="OverflowToolbarButton",d.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
