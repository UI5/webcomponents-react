...
**Note:** Available since [v2.11.0](https://github.com/UI5/webcomponents/releases/tag/v2.11.0) of **@ui5/webcomponents**.`,name:"accessibleDescriptionRef",required:!1,type:{name:"string"}},footer:{defaultValue:null,description:`Defines the footer HTML Element.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"footer",required:!1,type:{name:"UI5WCSlotsNode"}},open:{defaultValue:{value:"false"},description:`Indicates if the element is open
