import{s as W,d as x}from"./DemoProps-CtAguf8G.js";import{j as z}from"./useIsomorphicLayoutEffect-DvGGtHJq.js";import{r as E}from"./index-BP8_t0zE.js";import{P as H}from"./PieChart-DgilfNvo.js";import"./index-CBpU8qq5.js";import"./clsx-B-dksMZM.js";import"./defaults-DV_MWGrg.js";import"./ChartContainer-B0tVY47J.js";import"./_baseForOwn-B3hW39GE.js";import"./_baseUniq-BbzeZuBs.js";import"./index-DWZnENUk.js";import"./i18n-defaults-i2-x_YLi.js";import"./i18nBundle-B0EGx0z0.js";import"./Boot-DcdhI_RK.js";import"./EventProvider-B3ZIXKWe.js";import"./I18nContext-RJHUyvz-.js";import"./useStylesheet-DWFaJupJ.js";import"./throttle-Cgcjdhlw.js";import"./isString-CadNZdQX.js";import"./index-BZVLOrj-.js";import"./iframe-B-8EUAv7.js";import"../sb-preview/runtime.js";import"./Label-CfM8R4Pi.js";import"./UI5Element-infrDpAf.js";import"./CustomElementsScope-Dt2MhVrA.js";import"./withWebComponent-Czp6OQvU.js";import"./utils-lAiJ6aRh.js";import"./WrappingType-CW8URInd.js";import"./i18n-defaults-h9yeeTQy.js";import"./parameters-bundle.css-6UUskKkY.js";import"./tiny-invariant-CCoILDQG.js";import"./staticProps-Cibfnvql.js";import"./ThemingParameters-pyhX3s39.js";import"./useOnClickInternal-Cyu2xiYx.js";import"./Placeholder-BCtftTpW.js";import"./generateCategoricalChart-DWugcXCo.js";import"./isPlainObject-DMxkze9F.js";import"./mapValues-COmDofVS.js";import"./react-content-loader.es-1lMwhoXk.js";const t=E.forwardRef((e,j)=>{const N={legendPosition:"bottom",paddingAngle:0,innerRadius:"50%",...e.chartConfig};return z.jsx(H,{...e,ref:j,chartConfig:N,"data-component-name":"DonutChart"})});t.displayName="DonutChart";try{t.displayName="DonutChart",t.__docgenInfo={description:"A `DonutChart` is a type of graph that displays data in a circular graph with a cut-out hole in the middle.\nThe pieces of the graph are proportional to the fraction of the whole in each category.\nA `DonutChart` is basically a `PieChart` with a hole.",displayName:"DonutChart",props:{centerLabel:{defaultValue:null,description:"A label to display in the center of the `PieChart`.\nIf you use this prop to display a text, we recommend to increase `chartConfig.innerRadius` to have some free\nspace for the text.",name:"centerLabel",required:!1,type:{name:"string"}},dimension:{defaultValue:null,description:`A object which contains the configuration of the dimension.
...
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},onClick:{defaultValue:null,description:"Fired when clicked anywhere in the chart.",name:"onClick",required:!1,type:{name:"(event: CustomEvent<{ payload: unknown; activePayloads: Record<string, unknown>[]; }>) => void"}},dataset:{defaultValue:null,description:"The `dataset` is an array of object which will be displayed in the chart.",name:"dataset",required:!1,type:{name:"Record<string, unknown>[]"}},loading:{defaultValue:null,description:`Flag whether the chart should display a loading indicator.

This can either be a placeholder shimmer (in case the chart has no data yet) or a small
loading bar in the top of the chart (in case the chart has already some data to display).`,name:"loading",required:!1,type:{name:"boolean"}},noLegend:{defaultValue:null,description:"`noLegend` toggles the visibility of the legend below the chart. If this prop is `true`, no legend will be rendered.",name:"noLegend",required:!1,type:{name:"boolean"}},onDataPointClick:{defaultValue:null,description:"The `onDataPointClick` event fires whenever the user clicks on e.g. a  bar in `BarChart` or a point the `LineChart`.\n\nYou can use this event to trigger e.g. navigations or set filters based on the last clicked data point.",name:"onDataPointClick",required:!1,type:{name:"(event: CustomEvent<any>) => void"}},onLegendClick:{defaultValue:null,description:`The \`onLegendClick\` event fires when the user clicks on a label of the legend.
...
}`,...(T=(R=d.parameters)==null?void 0:R.docs)==null?void 0:T.source}}};const qe=["Default","WithCustomColor","WithPaddedAngle","WithCustomRadius","LoadingPlaceholder","WithFormatter","WithHighlightedActiveSegment","HideLabels"];export{a as Default,d as HideLabels,i as LoadingPlaceholder,n as WithCustomColor,r as WithCustomRadius,s as WithFormatter,l as WithHighlightedActiveSegment,o as WithPaddedAngle,qe as __namedExportsOrder,Ve as default};
