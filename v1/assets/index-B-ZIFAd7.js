import{_ as b}from"./iframe-BPNyQPyl.js";import{a as r,l as a,b as l,s as y,p as c,c as _,d as w,w as I}from"./withWebComponent-Czp6OQvU.js";import{e as R}from"./event-CegLCnR0.js";import{g as N}from"./Tooltips-BHdqPbjc.js";import{U as T}from"./UI5Element-infrDpAf.js";import{e as $,b as D,c as C,d as x,n as A,m as S,f as V,g as q}from"./Keys-BgUkNma0.js";import{g as E}from"./AriaLabelHelper-CzOXVcye.js";import{b as k}from"./i18nBundle-B0EGx0z0.js";import{I as P}from"./Integer-Dh6YzFpK.js";import{F as U}from"./Float-BYyKuwHF.js";import{p as O,q as z,r as B}from"./i18n-defaults-h9yeeTQy.js";import{c as M,I as F}from"./Icon-BkC3Ogwn.js";import"./favorite-Gtk69yt_.js";import"./unfavorite-CnYNQEEp.js";import{r as v}from"./Boot-DcdhI_RK.js";import{s as L}from"./parameters-bundle.css-6UUskKkY.js";function H(o,e,i){return r`<div class="ui5-rating-indicator-root" role="slider" aria-roledescription="${a(this._ariaRoleDescription)}" aria-valuemin="0" aria-valuenow="${a(this.value)}" aria-valuemax="${a(this.max)}" aria-valuetext="${a(this.value)} of ${a(this.max)}" aria-orientation="horizontal" aria-disabled="${a(this._ariaDisabled)}" aria-readonly="${a(this.ariaReadonly)}" aria-description="${a(this._ariaDescription)}" tabindex="${a(this.effectiveTabIndex)}" @focusin="${this._onfocusin}" @focusout="${this._onfocusout}" @click="${this._onclick}" @keydown="${this._onkeydown}" title="${a(this.ratingTooltip)}" aria-label="${a(this._ariaLabel)}"><ul class="ui5-rating-indicator-list" aria-hidden="true">${M(this._stars,(t,n)=>t._id||n,(t,n)=>W.call(this,o,e,i,t,n))}</ul></div>`}function W(o,e,i,t,n){return r`${t.selected?j.call(this,o,e,i,t,n):G.call(this,o,e,i,t,n)}`}function j(o,e,i,t,n){return i?r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-sel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-sel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function G(o,e,i,t,n){return r`${t.halfStar?K.call(this,o,e,i,t,n):X.call(this,o,e,i,t,n)}`}function K(o,e,i,t,n){return i?r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-half"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="unfavorite"></${l("ui5-icon",e,i)}><div class="ui5-rating-indicator-half-icon-wrapper"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite" class="ui5-rating-indicator-half-icon"></${l("ui5-icon",e,i)}></div></li>`:r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-half"><ui5-icon data-ui5-value="${a(t.index)}" name="unfavorite"></ui5-icon><div class="ui5-rating-indicator-half-icon-wrapper"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite" class="ui5-rating-indicator-half-icon"></ui5-icon></div></li>`}function X(o,e,i,t,n){return r`${this.readonly?Y.call(this,o,e,i,t,n):J.call(this,o,e,i,t,n)}`}function Y(o,e,i,t,n){return i?r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function J(o,e,i,t,n){return r`${this.disabled?Q.call(this,o,e,i,t,n):Z.call(this,o,e,i,t,n)}`}function Q(o,e,i,t,n){return i?r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="favorite"></${l("ui5-icon",e,i)}></li>`:r`<li class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="favorite"></ui5-icon></li>`}function Z(o,e,i,t,n){return i?r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><${l("ui5-icon",e,i)} data-ui5-value="${a(t.index)}" name="unfavorite"></${l("ui5-icon",e,i)}></li>`:r`<li data-ui5-value="${a(t.index)}" class="ui5-rating-indicator-item ui5-rating-indicator-item-unsel"><ui5-icon data-ui5-value="${a(t.index)}" name="unfavorite"></ui5-icon></li>`}v("@ui5/webcomponents-theming","sap_horizon",async()=>y);v("@ui5/webcomponents","sap_horizon",async()=>L);const ee={packageName:"@ui5/webcomponents",fileName:"themes/RatingIndicator.css.ts",content:`:host(:not([hidden])){display:inline-block;font-size:24px;margin:var(--_ui5-v1-24-22_rating_indicator_component_spacing);cursor:pointer}:host([disabled]){opacity:.4;cursor:initial;outline:none}:host([readonly]){cursor:initial}:host([disabled]) .ui5-rating-indicator-item-unsel,:host([readonly]) .ui5-rating-indicator-item-unsel{padding-inline:var(--_ui5-v1-24-22_rating_indicator_readonly_item_spacing);width:var(--_ui5-v1-24-22_rating_indicator_readonly_item_width);height:var(--_ui5-v1-24-22_rating_indicator_readonly_item_height)}:host(:not([readonly]):not([disabled])) .ui5-rating-indicator-root:hover{opacity:.9}:host([_focused]){outline:var(--sapContent_FocusWidth) var(--sapContent_FocusStyle) var(--sapContent_FocusColor);outline-offset:var(--_ui5-v1-24-22_rating_indicator_outline_offset);border-radius:var(--_ui5-v1-24-22_rating_indicator_border_radius)}[ui5-icon]{display:flex;text-shadow:var(--sapContent_TextShadow)}.ui5-rating-indicator-root{outline:none;position:relative}.ui5-rating-indicator-list{list-style-type:none;display:flex;align-items:center;margin:0;padding:0}.ui5-rating-indicator-item{position:relative;width:var(--_ui5-v1-24-22_rating_indicator_item_width);height:var(--_ui5-v1-24-22_rating_indicator_item_height)}.ui5-rating-indicator-item:not(:last-child){margin-inline-end:.1875rem}.ui5-rating-indicator-item [ui5-icon]{width:100%;height:100%;color:inherit;user-select:none}.ui5-rating-indicator-item.ui5-rating-indicator-item-sel{color:var(--sapContent_RatedColor)}.ui5-rating-indicator-item.ui5-rating-indicator-item-unsel,.ui5-rating-indicator-item.ui5-rating-indicator-item-half{color:var(--sapContent_UnratedColor)}.ui5-rating-indicator-item [ui5-icon].ui5-rating-indicator-half-icon{position:absolute;inset-inline-start:50%;color:var(--sapContent_RatedColor)}.ui5-rating-indicator-half-icon-wrapper{width:100%;height:100%;position:absolute;inset-inline-start:-50%;top:0;z-index:32;overflow:hidden}
`};var d=function(o,e,i,t){var n=arguments.length,u=n<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,i):t,h;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")u=Reflect.decorate(o,e,i,t);else for(var m=o.length-1;m>=0;m--)(h=o[m])&&(u=(n<3?h(u):n>3?h(e,i,u):h(e,i))||u);return n>3&&u&&Object.defineProperty(e,i,u),u},p;let s=p=class extends T{static async onDefine(){p.i18nBundle=await k("@ui5/webcomponents")}constructor(){super()}onBeforeRendering(){this.calcState()}calcState(){this._stars=[];for(let e=1;e<this.max+1;e++){const i=Math.round((this.value-Math.floor(this.value))*10);let t=!1,n=this.value;Math.floor(this.value)+1===e&&i>2&&i<8?t=!0:i<=2?n=Math.floor(this.value):i>=8&&(n=Math.ceil(this.value)),this._stars.push({selected:e<=n,index:e,halfStar:t})}}_onclick(e){const i=e.target;if(!(i instanceof HTMLElement)||this.disabled||this.readonly)return;const t=i.getAttribute("data-ui5-value");t!==null&&(this.value=parseInt(t),this.value===1&&this._liveValue===1&&(this.value=0),this._liveValue!==this.value&&(this.fireEvent("change"),this._liveValue=this.value))}_onkeydown(e){if(this.disabled||this.readonly)return;const i=$(e)||D(e),t=C(e)||x(e),n=A(e)||S(e),u=V(e),h=q(e),m=e.keyCode>=48&&e.keyCode<=57||e.keyCode>=96&&e.keyCode<=105;if(i||t||n||u||h||m){if(e.preventDefault(),i&&this.value>0)this.value=Math.round(this.value-1);else if(t&&this.value<this.max)this.value=Math.round(this.value+1);else if(n){const f=Math.round(this.value+1);this.value=f>this.max?0:f}else if(u)this.value=0;else if(h)this.value=this.max;else if(m){const f=parseInt(e.key);this.value=f>this.max?this.max:f}this.fireEvent("change")}}_onfocusin(){this.disabled||(this._focused=!0,this._liveValue=this.value)}_onfocusout(){this._focused=!1}get effectiveTabIndex(){const e=this.getAttribute("tabindex");return this.disabled?"-1":e||"0"}get ratingTooltip(){return this.tooltip?this.tooltip:N()?this.defaultTooltip:void 0}get defaultTooltip(){return p.i18nBundle.getText(O)}get _ariaRoleDescription(){return p.i18nBundle.getText(z)}get _ariaDisabled(){return this.disabled||void 0}get _ariaLabel(){return E(this)}get _ariaDescription(){return this.required?p.i18nBundle.getText(B):void 0}get ariaReadonly(){return this.readonly?"true":void 0}};d([c({validator:U,defaultValue:0})],s.prototype,"value",void 0);d([c({validator:P,defaultValue:5})],s.prototype,"max",void 0);d([c({type:Boolean})],s.prototype,"disabled",void 0);d([c({type:Boolean})],s.prototype,"readonly",void 0);d([c()],s.prototype,"accessibleName",void 0);d([c({defaultValue:""})],s.prototype,"accessibleNameRef",void 0);d([c({type:Boolean})],s.prototype,"required",void 0);d([c()],s.prototype,"tooltip",void 0);d([c({type:Object,multiple:!0})],s.prototype,"_stars",void 0);d([c({type:Boolean})],s.prototype,"_focused",void 0);s=p=d([_({tag:"ui5-rating-indicator",languageAware:!0,renderer:w,styles:ee,template:H,dependencies:[F]}),R("change")],s);s.define();const ie=s,te=Object.freeze(Object.defineProperty({__proto__:null,default:ie},Symbol.toStringTag,{value:"Module"})),g=I("ui5-rating-indicator",["accessibleName","accessibleNameRef","max","tooltip","value"],["disabled","readonly","required"],[],["change"],()=>b(()=>Promise.resolve().then(()=>te),void 0,import.meta.url));g.displayName="RatingIndicator";try{g.displayName="RatingIndicator",g.__docgenInfo={description:`The Rating Indicator is used to display a specific number of icons that are used to rate an item.
