import{j as e}from"./useIsomorphicLayoutEffect-DvGGtHJq.js";import{r as h,i as k}from"./Boot-DcdhI_RK.js";import{r as f}from"./Icons-BFUWD3ZY.js";import{a as B}from"./add-lB5XsFy7.js";import{e as G}from"./employee-0nfTRhP-.js";import{s as J}from"./settings-prpy4iop.js";import{b as R,a as g,c as K,d as q,T as t}from"./index-ChqDpS4c.js";import{_ as Q}from"./iframe-BPNyQPyl.js";import{U as X,e as S}from"./UI5Element-infrDpAf.js";import{a as x,l as i,b as w,s as H,p as Y,c as Z,d as ee,w as te}from"./withWebComponent-Czp6OQvU.js";import{o as y}from"./class-map-DfcPub6e.js";import{s as v}from"./style-map-Bl1Jni_s.js";import{s as F}from"./parameters-bundle.css-6UUskKkY.js";function ae(a,n,o){return x`<div id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" .realTabReference="${i(this)}"></div>`}function ne(a,n,o){return o?x`<${w("ui5-li-custom",n,o)} id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" disabled style="${v(this._style)}" .realTabReference="${i(this)}"></${w("ui5-li-custom",n,o)}>`:x`<ui5-li-custom id="${i(this._id)}" role="separator" class="${y(this.classes.root)}" disabled style="${v(this._style)}" .realTabReference="${i(this)}"></ui5-li-custom>`}h("@ui5/webcomponents-theming","sap_horizon",async()=>H);h("@ui5/webcomponents","sap_horizon",async()=>F);const oe={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInStrip.css.ts",content:`.ui5-tc__separator{position:relative;width:.5625rem}.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
`};h("@ui5/webcomponents-theming","sap_horizon",async()=>H);h("@ui5/webcomponents","sap_horizon",async()=>F);const re={packageName:"@ui5/webcomponents",fileName:"themes/TabSeparatorInOverflow.css.ts",content:`.ui5-tc__separator{min-height:.25rem;border-bottom:.0625rem solid var(--sapGroup_TitleBorderColor);margin-inline-start:calc(var(--_ui5-v1-24-22-tab-indentation-level) * .5rem);margin-inline-end:.5rem}[ui5-list]>.ui5-tc__separator:first-child{min-height:.5rem}
