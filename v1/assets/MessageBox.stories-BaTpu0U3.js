import{j as o}from"./useIsomorphicLayoutEffect-DvGGtHJq.js";import"./index-zvLnitT_.js";import{r as c}from"./index-BP8_t0zE.js";import{r as M}from"./index-BxmsGmlx.js";import{M as h,a as O,b as m}from"./index-CvZu9Hu_.js";import{B as p}from"./index-DnS1P2L3.js";const u=c.forwardRef((e,s)=>M.createPortal(o.jsx(h,{...e,ref:s}),document.body));u.displayName="MessageBox";const b={title:"Modals & Popovers / MessageBox",component:h,argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},args:{open:!1,type:O.Confirm,children:'Press "Escape" to close the MessageBox.'},parameters:{chromatic:{delay:1e3}},tags:["package:@ui5/webcomponents","cem-module:Dialog"]},t={render(e){const[s,n]=c.useState(e.open),l=()=>{n(!0)},i=r=>{n(!1),e.onClose(r)};return c.useEffect(()=>{n(e.open)},[e.open]),o.jsxs(o.Fragment,{children:[o.jsx(p,{onClick:l,children:"Open Messagebox"}),o.jsx(u,{...e,open:s,onClose:i})]})}},a={args:{actions:[m.OK,"Custom Action",m.Cancel,o.jsx(p,{id:"custom-action",children:"Custom Button"},"0")]},render(e){const[s,n]=c.useState(!1),l=()=>{n(!0)},i=r=>{r.detail.action,n(!1),e.onClose(r)};return o.jsxs(o.Fragment,{children:[o.jsx(p,{onClick:l,children:"Open Messagebox"}),o.jsx(u,{...e,open:s,onClose:i})]})}};var d,C,g;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render(args) {
